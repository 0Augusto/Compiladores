...
define noalias noundef ptr @newWorkList(i32 noundef %0) local_unnamed_addr #0 {
  %2 = sext i32 %0 to i64
  %3 = tail call ptr @calloc(i64 noundef %2, i64 noundef 4) #12
...
define noalias noundef ptr @newCombList(i32 noundef %0) local_unnamed_addr #0 {
  %2 = sext i32 %0 to i64
  %3 = tail call ptr @calloc(i64 noundef %2, i64 noundef 12) #12
  %4 = icmp eq ptr %3, null
  br i1 %4, label %6, label %5
...
15:                                               ; preds = %5, %5
  ...
  %25 = call ptr @calloc(i64 noundef %24, i64 noundef 4) #12
...
30:                                               ; preds = %15
  ...
  %31 = call ptr @calloc(i64 noundef %20, i64 noundef 12) #12
...
36:                                               ; preds = %30
  ...
  %37 = call ptr @calloc(i64 noundef %20, i64 noundef 12) #12
